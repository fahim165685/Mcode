...
import 'package:mcode/screen/admin/massege/component/animated-dialog.dart';
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: const [
            ...
            SizedBox(width: 30,child: Center(child: Text('John',style: TextStyle(height: 1.5,fontSize: 12,color: Colors.white),overflow: TextOverflow.ellipsis,)))
          ],
        ),
      ),
    );
